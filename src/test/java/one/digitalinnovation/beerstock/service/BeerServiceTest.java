...
public class BeerServiceTest {
    ...
    @Test
    void whenListBeerIsCalledReturnAListOfBeers(){
    	//given
    	BeerDTO expectedFoundBeerDTO =  BeerDTOBuilder.builder().build().toBeerDTO();
    	Beer expectedFoundBeer = beerMapper.toModel(expectedFoundBeerDTO);
    ...
    @Test
    void whenListBeerIsCalledReturnAnEmptyListofBerrs(){
    ...
    @Test
    void whenExclusionIsCalledWithValideIdThenABeerShouldBeDeleted () throws BeerNotFoundException{
    	//given
